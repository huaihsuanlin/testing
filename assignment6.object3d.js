...
class ShadedObject3D extends Object3D { 
    ...
    createVAO( gl, shader )
    {
        ...
        if (location >= 0) {
            ...
            gl.enableVertexAttribArray( location )
            stride = 0, offset = (this.vertices.length * 3 / 11) * Float32Array.BYTES_PER_ELEMENT
            gl.vertexAttribPointer( location, this.num_components_vec3, gl.FLOAT, false, stride, offset )
        }
        ...
        if (location >= 0 && this.material.hasTexture()) {
            ...
            gl.enableVertexAttribArray( location )
            stride = 0, offset = (this.vertices.length * 6 / 11) * Float32Array.BYTES_PER_ELEMENT
            gl.vertexAttribPointer( location, this.num_components_vec3, gl.FLOAT, false, stride, offset )
        }
        ...
        if (location >= 0 && this.material.hasTexture()) {
            ...
            gl.enableVertexAttribArray( location )
            stride = 0, offset = (this.vertices.length * 9 / 11) * Float32Array.BYTES_PER_ELEMENT
